document.addEventListener("DOMContentLoaded", async function () {
    ...
    // Expandable sidebar sections (Welcome packs & guides, Quick Tools, …).
    // Each toggle controls the row named in its aria-controls attribute.
    document.querySelectorAll('.guides-toggle').forEach((toggle) => {
